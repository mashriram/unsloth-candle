...
class ModelWrapper(nn.Module):
    ...
    def save_pretrained_merged(
        self, output_dir, tokenizer=None, save_method="merged_16bit", **kwargs
    ):
    ...
    def save_pretrained_gguf(
        self, output_dir, tokenizer=None, quantization_type="q8_0", **kwargs
    ):
    ...
    def push_to_hub_merged(
        self, repo_id, tokenizer, save_method="merged_16bit", token=None, **kwargs
    ):
...
class FastLanguageModel:
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        """
        Loads a model and tokenizer, forwarding dtype to the Rust backend if supported.
        dtype: "float32", "bf16", etc. (default: "float32")
        """
